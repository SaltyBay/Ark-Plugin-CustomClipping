...
REM ========================================================
set ProjectName=CustomClipping

REM ========================================================
REM configure description
REM ========================================================
set Description=custom clipping
...
echo #
  ...
  git clone https://github.com/SaltyBay/ARK-Server-API.git --branch feature/UObject-GetPrivateStaticClass
